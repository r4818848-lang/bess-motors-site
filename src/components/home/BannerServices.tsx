          ...
          {serviceIds.map((svc, i) => {
            ...
            return (
              ...
              >
                <Link
                  href="/services"
                  className="block h-full rounded-xl border-2 border-bm-red/60 bg-bm-card/80 p-5 transition-all duration-300 hover:border-bm-red hover:shadow-neon group neon-border"
                  style={{
                    boxShadow: "0 0 15px rgba(225, 6, 0, 0.15), inset 0 0 20px rgba(225, 6, 0, 0.03)",
                  }}
                >
