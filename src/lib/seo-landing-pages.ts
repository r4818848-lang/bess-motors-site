...
export const seoLandingPages: SeoLandingPage[] = [
  {
    ...
    metaTitle: "Diagnostyka komputerowa Warszawa Włochy",
    metaDescription:
      "Diagnostyka komputerowa w BESS MOTORS Warszawa Włochy — Check Engine, błędy silnika, elektryka. Aleja Krakowska 48/52, zapis online.",
  ...
  },
  {
    ...
    metaTitle: "Geometria kół Warszawa Włochy",
    metaDescription:
      "Geometria i zbieżność kół w BESS MOTORS Warszawa. Auto ściąga na bok — ustawienie osi. Aleja Krakowska 48/52, Włochy.",
    serviceId: "alignment",
    icon: "Crosshair",
  },
  {
    ...
    metaTitle: "Naprawa silnika Warszawa — diagnostyka",
    metaDescription:
      "Naprawa silnika w BESS MOTORS Warszawa Włochy — diagnostyka, wycieki, rozrząd, turbosprężarka. Aleja Krakowska 48/52, zapis online.",
    serviceId: "engine",
    icon: "Cog",
  },
  {
    ...
    metaTitle: "Elektryk samochodowy Warszawa Włochy",
    metaDescription:
      "Elektryk samochodowy Warszawa — Check Engine, czujniki, instalacja, rozrusznik, alternator. BESS MOTORS Aleja Krakowska 48/52.",
    serviceId: "electric",
    icon: "Zap",
  },
  {
  ...
  },
  {
    ...
    metaTitle: "Wulkanizacja Warszawa — wymiana opon Włochy",
    metaDescription:
      "Wulkanizacja Warszawa Włochy: wymiana i wyważanie opon bez kolejki. BESS MOTORS, Aleja Krakowska 48/52. Zapis online.",
    serviceId: "tires",
    icon: "Circle",
  },
  {
  ...
  },
  {
    ...
    metaTitle: "Check Engine Warszawa — diagnostyka błędów",
    metaDescription:
      "Świeci Check Engine? Odczyt błędów OBD i naprawa w BESS MOTORS Warszawa Włochy. Aleja Krakowska 48/52 — zapis online.",
    serviceId: "diagnostic",
    icon: "ScanLine",
  },
  {
  ...
  },
  {
    ...
    line1: acPromoHeroLinePl(),
    line2: "Napełnianie R134a, R1234yf i odgrzybianie",
    metaTitle: "Serwis klimatyzacji Warszawa — od 130 zł | BESS MOTORS",
    metaDescription: acPromoMetaDescriptionPl(),
    serviceId: "acRefill",
    icon: "Settings",
  },
  ...
  },
  {
    ...
    metaTitle: "Promocje BESS MOTORS — olej 80 zł + zawieszenie gratis",
    metaDescription:
      "Kod BessMotors: wymiana oleju 80 zł (było 150) + zawieszenie gratis przy oleju, klocki od 100 zł. Warszawa Włochy.",
    serviceId: "otherReason",
    icon: "Tag",
  },
];
