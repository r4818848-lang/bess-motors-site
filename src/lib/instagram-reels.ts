...
export const INSTAGRAM_REELS: InstagramReel[] = [
  {
    ...
    caption: {
      pl: "Podłączenie 80 zł, gaz certyfikowany 50 zł/100 g — R134a i R1234yf. Serwis klimatyzacji w BESS MOTORS.",
      ru: "Подключение 80 zł, сертифицированный газ 50 zł/100 г — R134a и R1234yf. Сервис кондиционера в BESS MOTORS.",
      en: "Hook-up 80 PLN, certified gas 50 PLN/100g — R134a and R1234yf. A/C service at BESS MOTORS.",
    },
    instagramUrl:
