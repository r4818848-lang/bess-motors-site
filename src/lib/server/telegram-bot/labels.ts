...
export const BOT = {
  ...
  importPrompt:
    "📄 <b>Импорт заказ-наряда</b>\n\nОтправьте <b>PDF</b> или <b>фото</b> (Motowarsztat).\nЧитаются клиент, авто, <b>работы</b> и <b>запчасти</b>.\nПеред созданием проверьте данные в CRM (закуп запчастей для учёта прибыли).",
