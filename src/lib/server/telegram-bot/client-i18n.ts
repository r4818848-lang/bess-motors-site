...
const LABELS: Record<BotLocale, ClientBotLabels> = {
  pl: {
    ...
    ordersEmpty: "📋 <b>Historia</b>\n\nBrak wizyt i zleceń.",
    ordersTitle: (p, t) => `📋 <b>Historia</b> (${p}/${t})`,
  ...
  ru: {
    ...
    ordersEmpty: "📋 <b>История</b>\n\nПока нет записей и заказ-нарядов.",
    ordersTitle: (p, t) => `📋 <b>История</b> (${p}/${t})`,
  ...
  uk: {
    ...
    ordersEmpty: "📋 <b>Історія</b>\n\nПоки немає записів і замовлень.",
    ordersTitle: (p, t) => `📋 <b>Історія</b> (${p}/${t})`,
  ...
  en: {
    ...
    ordersEmpty: "📋 <b>History</b>\n\nNo appointments or work orders yet.",
    ordersTitle: (p, t) => `📋 <b>History</b> (${p}/${t})`,
