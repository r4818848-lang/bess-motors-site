...
const RELATED_SLUGS: Record<string, string[]> = {
  ...
  "warszawa-ursynow": ["warszawa-wlochy", "warszawa-mokotow", "diagnostyka", "hamulce", "kontakt"],
  "warszawa-mokotow": ["warszawa-wlochy", "warszawa-ursynow", "warszawa-ochota", "opony", "diagnostyka"],
  "warszawa-ochota": ["warszawa-wlochy", "warszawa-mokotow", "hamulce", "kontakt", "wymiana-oleju"],
