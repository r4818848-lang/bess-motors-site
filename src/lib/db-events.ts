...
export const DB_STORAGE_QUOTA_EVENT = "bess-db-storage-quota";
...
export function notifyDbStorageQuotaExceeded(): void {
  if (typeof window === "undefined") return;
  window.dispatchEvent(new CustomEvent(DB_STORAGE_QUOTA_EVENT));
}
